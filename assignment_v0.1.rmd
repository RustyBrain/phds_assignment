...
pal_grand <- colorNumeric(palette = "Blues", domain = utlas$grand_mean)
pal_soc <- colorNumeric(palette = "Blues", domain = utlas$social_determinants)
pal_risk <- colorNumeric(palette = "Blues", domain = utlas$risk_factors)
pal_outcomes <- colorNumeric(palette = "Blues", domain = utlas$health_outcomes)
